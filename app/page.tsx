  ...
  },
  {
    ...
    calculators: [
      ...
      { slug: 'emergency-fund', 
        ...
        description: 'Calculate your ideal emergency fund size based on essential expenses, job stability, and household situation. See savings milestones and time to goal.', 
        badge: 'New',
      },
    ],
  },
  {
    ...
    calculators: [
      ...
      { slug: 'credit-card-minimum-payment', 
        href: '/calculators/credit-card-minimum-payment', 
        title: 'Credit Card Minimum Payment Calculator', 
        description: 'See the true cost of making only minimum payments and how much you save by paying a fixed amount or extra each month.', 
        badge: 'New', 
      },
    ],
  },
